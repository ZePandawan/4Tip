...
// ID Role Coder
const ID_role : string = '1139102720540803152';


function checkAdmin(client, interaction) : boolean{
...
function addWarn(server_id, user_id, reason, timestamp, nb_warns, warner_id): void{
